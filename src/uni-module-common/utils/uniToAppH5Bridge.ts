...
// 2026寒假阅读活动跳转活动介绍页
const holidayReadIntroH5Url = `${baseUrl}/v2/act/summer-math/common-intro?activityId=26?unimpParams=1&jsr=true`;
// 2026寒假阅读活动跳转积分规则页
const holidayReadRuleH5Url = `${baseUrl}/v2/act/summer-math/score-strategy?activityId=26?unimpParams=1`;
...
export const holidayReadIntroH5 = (paramsStr = '') => {
  goToH5(`${holidayReadIntroH5Url}${paramsStr}`);
};
export const holidayReadRuleH5 = (paramsStr = '') => {
  goToH5(`${holidayReadRuleH5Url}${paramsStr}`);
};
